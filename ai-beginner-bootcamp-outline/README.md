# FREE COURSE: 5-DAY AI BEGINNER BOOTCAMP

## Program Snapshot
- **Duration:** 5 Days (Wednesday - Sunday)
- **Time:** 6:00 PM - 8:00 PM (WAT)
- **Format:** Live virtual sessions with practical demonstrations
...
## Certification
All participants who complete the program will receive:
- **Agentic Labs - AI Fundamentals Certificate**

## Final CTA (End of Day 5)
You now understand how AI works, how to use it, and how it can create opportunities.

The next step is to go deeper, build real projects, and start applying these skills consistently.

In the **AI Beginner Bundle**, participants will:
- Learn AI in a structured way
- Build real-world projects
- Receive guided support and mentorship
- Develop practical skills they can use to earn

More details will be shared at the end of the session.

## Community CTA
- Follow Agentic Labs on social media
- Join the learning community / waitlist
- Stay updated on future workshops and resources

---

## Optional Facilitator Notes
- Keep language non-technical and practical in Days 1-3.
- Use local, relatable examples (education, jobs, side hustle, admin work).
